...
const delayValue = (ms) => new Promise((res) => setTimeout(() => res(`Waited ${ms} ms`), ms));
async function runDelays(numbers) {
...
const delayValue1 = (ms) => new Promise((res) => {
...
async function runDelays1(numbers) {
